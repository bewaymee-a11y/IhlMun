...
const translations = {
  en: {
    ...
    munExperienceQ: 'Please describe your previous MUN experiences (delegate, chair, USG, awards, etc.) If this is your first time, type «N/A».',
    motivationQ: 'Please explain your motivation for participating in Model United Nations and how this experience aligns with your academic and personal goals. (250 words max.).',
    globalCrisisQ: 'Among the many global crises facing humanity today, choose the one that you feel most deeply connected to and explain why it matters to you personally. (200-300 words).',
  ...
  ru: {
    ...
    munExperienceQ: 'Пожалуйста, опишите ваш предыдущий опыт участия в MUN (делегат, председатель, USG, награды и т.д.). Если вы участвуете впервые, напишите «N/A».',
    motivationQ: 'Пожалуйста, опишите ваши цели и причины участия в Model United Nations и объясните, как этот опыт способствует вашим академическим и личностным достижениям. (макс. 250 слов).',
    globalCrisisQ: 'Среди множества глобальных кризисов, с которыми сталкивается человечество сегодня, выберите тот, к которому вы чувствуете наибольшую личную связь, и объясните, почему он важен именно для вас. (200–300 слов).',
    submitApplication: 'Отправить заявку',
    applicationReceived: 'Заявка получена!',
    thankYouApplying: 'Спасибо за подачу заявки в',
    reviewContact: 'Наша команда по связям с делегатами рассмотрит вашу заявку и свяжется с вами в ближайшее время.',
