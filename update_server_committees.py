...
replacement = """INITIAL_COMMITTEES = [
    {
        "id": str(uuid.uuid4()),
...
# Substitute the INITIAL_COMMITTEES list in server.py
new_text = re.sub(r'INITIAL_COMMITTEES\s*=\s*\[.*?\]', replacement, text, flags=re.DOTALL)
